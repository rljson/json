...
Replace `Rework nullability handling` here and below
by your new pull request title.

## Create a feature branch

```bash
node scripts/create-branch.js "Rework nullability handling"
```
...
```bash
git add .
git commit -am"Rework nullability handling"
```
...
```bash
gh pr create --base main --title "Rework nullability handling" --body " "
```
